...
## What you defer
- Colour → `perception-and-color`. Type → `dc-typography`. Chart forms → `dc-charting`. Screen navigation/usability → `dc-layout`. Overall theme/mood and the *choice* of signature → `dc-art-director`.
