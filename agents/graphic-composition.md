...
## What you defer
- Colour → `perception-and-color`. Type → `typesetting`. Chart forms → `tufte-charting`. Screen navigation/usability → `ux`. Overall theme/mood and the *choice* of signature → `dc-art-director`.
