...
## What you defer
- Chart *form* → `tufte-charting`. Colour → `perception-and-color`. Type → `typesetting`. The borrowed structural *signature* and its meaning → `dc-composition` / `dc-art-director` (you make it usable; they make it distinctive).
