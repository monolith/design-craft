...
## What you defer
- Everything the four evidence skills own (`dc-color`, `dc-charting`, `dc-typography`, `dc-layout`) — you never override them. Inventing a *new* style → `dc-art-director` (developing-style). You *apply* a settled look; the art-director *invents* one.
