...
## What you defer
- Colour *science*, contrast, palette construction → `perception-and-color`. Type *selection* → `dc-typography`. Layout → `dc-layout`. Overall theme/feel → `dc-art-director`. (You judge identity coherence; they own the levers.)
