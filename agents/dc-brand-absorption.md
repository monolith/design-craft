...
## What you defer
- Colour *science* / WCAG / palette construction → `dc-color`. Type *selection* → `dc-typography`. Layout → `dc-layout`. (You capture *what the brand is*; the specialists execute within your binding direction.)
